...
export class AddTblReview1693321446614 implements MigrationInterface {
    name = 'AddTblReview1693321446614'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "categories" RENAME COLUMN "name" TO "title"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "categories" RENAME COLUMN "title" TO "name"`);
    }
